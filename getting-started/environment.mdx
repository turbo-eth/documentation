...
description: "Enable Application Features"
---
 
If you are using the [TurboETH CLI](/getting-started/cli), it will automatically generate a `.env.local` file for you based on your answers to the CLI prompts. If you are not using the CLI, you can copy the `.env.example` file to `.env.local` and generate the required environment variables.
