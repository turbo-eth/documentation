...
Web3 spans everything from always-online blockchains, distributed storage to private decentralized identity. We need an elegant and expressive build system to abstract the complexity of global coordination protocol.
